                        ...
                        <div class="col-md-6">
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Form Tambah Bahan Baku</h3>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="satuan" class="form-control"
                                            placeholder="Contoh: Kg, Liter, Pcs" value="{{ old('satuan') }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="batas_minimum" class="form-control"
                                            placeholder="Masukan Batas Minimum" value="{{ old('batas_minimum') }}">
